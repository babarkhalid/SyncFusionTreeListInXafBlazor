...
namespace SyncFusionTreeListInXafBlazor.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class SyncFusionTreeListInXafBlazorModule : ModuleBase {
    public SyncFusionTreeListInXafBlazorModule() {
		// 
		// SyncFusionTreeListInXafBlazorModule
		// 
